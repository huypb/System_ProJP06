...
public class CategoryItem extends SectionItem {
	...
	public String toString() {
		...
		builder.append(", category_section_id=");
		builder.append(category_section_id);
		builder.append(", category_notes=");
		builder.append(category_notes);
		builder.append(", category_created_date=");
		builder.append(category_created_date);
		builder.append(", category_created_author_id=");
		builder.append(category_created_author_id);
		builder.append(", category_last_modified=");
		builder.append(category_last_modified);
		builder.append(", category_manager_id=");
		builder.append(category_manager_id);
		builder.append(", category_enable=");
		builder.append(category_enable);
		builder.append(", category_delete=");
		builder.append(category_delete);
		builder.append(", category_image=");
		builder.append(category_image);
		builder.append(", category_name_en=");
		builder.append(category_name_en);
		builder.append(", category_language=");
		builder.append(category_language);
