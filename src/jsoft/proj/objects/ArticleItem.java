package jsoft.proj.objects;

public class ArticleItem extends CategoryItem{
  ...
  private String article_visited;
  ...
  public String getArticle_visited() {
  ...
  public void setArticle_visited(String article_visited) {
  ...
  public void setArticle_fee(String article_fee) {
...
public String toString() {
	...
	builder.append(article_content);
	builder.append(", article_created_date=");
	builder.append(article_created_date);
	builder.append(", article_last_modified=");
	builder.append(article_last_modified);
	builder.append(", article_image=");
	builder.append(article_image);
	builder.append(", article_category_id=");
	builder.append(article_category_id);
	builder.append(", article_section_id=");
	builder.append(article_section_id);
	builder.append(", article_visited=");
	builder.append(article_visited);
	builder.append(", article_author_name=");
	builder.append(article_author_name);
	builder.append(", article_enable=");
	builder.append(article_enable);
	builder.append(", article_url_link=");
	builder.append(article_url_link);
	builder.append(", article_tag=");
	builder.append(article_tag);
	builder.append(", article_title_en=");
	builder.append(article_title_en);
	builder.append(", article_summary_en=");
	builder.append(article_summary_en);
	builder.append(", article_content_en=");
	builder.append(article_content_en);
	builder.append(", article_tag_en=");
	builder.append(article_tag_en);
	builder.append(", article_fee=");
	builder.append(article_fee);
	builder.append(", article_isfee=");
	builder.append(article_isfee);
	builder.append(", article_delete=");
	builder.append(article_delete);
	builder.append(", article_deleted_date=");
	builder.append(article_deleted_date);
	builder.append(", article_restored_date=");
	builder.append(article_restored_date);
	builder.append(", article_modified_author_name=");
	builder.append(article_modified_author_name);
	builder.append(", article_author_permission=");
	builder.append(article_author_permission);
	builder.append(", article_source=");
	builder.append(article_source);
	builder.append(", article_language=");
	builder.append(article_language);
	builder.append(", article_focus=");
	builder.append(article_focus);
