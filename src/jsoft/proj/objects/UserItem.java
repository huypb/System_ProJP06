...
public class UserItem {
	...
	public String toString() {
		...
		builder.append(user_pass);
		builder.append(", user_fullname=");
		builder.append(user_fullname);
		builder.append(", user_birthday=");
		builder.append(user_birthday);
		builder.append(", user_mobilephone=");
		builder.append(user_mobilephone);
		builder.append(", user_homephone=");
		builder.append(user_homephone);
		builder.append(", user_officephone=");
		builder.append(user_officephone);
		builder.append(", user_email=");
		builder.append(user_email);
		builder.append(", user_address=");
		builder.append(user_address);
		builder.append(", user_jobarea=");
		builder.append(user_jobarea);
		builder.append(", user_job=");
		builder.append(user_job);
		builder.append(", user_position=");
		builder.append(user_position);
		builder.append(", user_applyyear=");
		builder.append(user_applyyear);
		builder.append(", user_permission=");
		builder.append(user_permission);
		builder.append(", user_notes=");
		builder.append(user_notes);
		builder.append(", user_roles=");
		builder.append(user_roles);
		builder.append(", user_logined=");
		builder.append(user_logined);
		builder.append(", user_alias=");
		builder.append(user_alias);
		builder.append("]");
