...
public class SectionItem {
	...
	public String toString() {
		...
		builder.append(section_name);
		builder.append(", section_notes=");
		builder.append(section_notes);
		builder.append(", section_created_date=");
		builder.append(section_created_date);
		builder.append(", section_manager_id=");
		builder.append(section_manager_id);
		builder.append(", section_enable=");
		builder.append(section_enable);
		builder.append(", section_delete=");
		builder.append(section_delete);
		builder.append(", section_last_modified=");
		builder.append(section_last_modified);
		builder.append(", section_created_author_id=");
		builder.append(section_created_author_id);
		builder.append(", section_name_en=");
		builder.append(section_name_en);
